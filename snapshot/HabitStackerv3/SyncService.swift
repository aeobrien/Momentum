...
class SyncService: ObservableObject {
    ...
    func buildPayload() -> LPMomentumPayload {
        ...
        // Load pending routine runs
        let pendingRuns = RoutineRunStore.shared.loadAll()
    ...
    func sync() async {
        ...
        do {
            ...
            // Clear pending routine runs after successful sync
            RoutineRunStore.shared.clearAll()
